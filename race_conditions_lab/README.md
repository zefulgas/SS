...
- You may want to try first your script without trying to win the race. File `vulp-v0.sh` sleeps for 3 seconds to give you a vulnerability window between the TOC and TOU. This one is easier to defeat.
